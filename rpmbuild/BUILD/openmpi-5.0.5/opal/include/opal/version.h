...
#define OPAL_CONFIGURE_CLI " \'--prefix=/usr/openmpi-5.0.5\' \'--with-libevent=/opt/libevent/release\' \'--with-hwloc=/opt/hwloc/release\' \'--with-pmix=/opt/pmix/release\' \'--with-slurm\'"
