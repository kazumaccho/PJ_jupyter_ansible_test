...
{
	export MPIRUN=
	export LIBUCS=/root/rpmbuild/BUILD/ucx-1.17.0/src/ucs/.libs/libucs.so
	export LIBUCT=/root/rpmbuild/BUILD/ucx-1.17.0/src/uct/.libs/libuct.so
	export LIBUCP=/root/rpmbuild/BUILD/ucx-1.17.0/src/ucp/.libs/libucp.so
	export VERBOSE=0
	export EXE=""
	export EXE_ARGS=""
...
run_open_mpi()
{
	...
	then
		...
		EXE="valgrind \
			...
			--suppressions=/root/rpmbuild/BUILD/ucx-1.17.0/test/mpi/ompi.supp \
			$VALGRIND_ARGS \
			$EXE"
